...
// TODO: removed for now using PicklesDoc.Pickles.DocumentationBuilders.Excel;
using PicklesDoc.Pickles.DocumentationBuilders.HTML;
using PicklesDoc.Pickles.DocumentationBuilders.JSON;
// TODO: removed for now using PicklesDoc.Pickles.DocumentationBuilders.Word;
...
namespace PicklesDoc.Pickles
{
    public class PicklesModule : Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            // TODO builder.RegisterType<WordDocumentationBuilder>().SingleInstance();
            builder.RegisterType<JsonDocumentationBuilder>().SingleInstance();
            // TODO builder.RegisterType<ExcelDocumentationBuilder>().SingleInstance();
            ...
            builder.Register<IDocumentationBuilder>(c =>
            {
                ...
                switch (configuration.DocumentationFormat)
                {
                    ...
                    // TODO case DocumentationFormat.Word:
                    // TODO     return c.Resolve<WordDocumentationBuilder>();
                    case DocumentationFormat.Json:
                        return c.Resolve<JsonDocumentationBuilder>();
                    // TODO case DocumentationFormat.Excel:
                    // TODO     return c.Resolve<ExcelDocumentationBuilder>();
